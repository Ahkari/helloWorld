欢迎大家来参加这次的培训，说是培训，其实是个比较随意点的分享会。

这段时间对于前端测试进行了调研，试验了一些测试方案和框架，也自己思考了些问题的解决方案。
现在分享下心得，并将自己总结的比较好的，完备的前端测试方案提出来供大家在工作中参考使用。

我们的测试是基于前端最重要的语言javascript的，所以我们使用的工具选择也是尽量往js上靠拢。
